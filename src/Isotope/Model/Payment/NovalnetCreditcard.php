...
class NovalnetCreditcard extends Postsale implements IsotopePayment
{
    /**
     * @var NovalnetHelper
     */
    ...
    */
    ...
    public function checkoutForm(IsotopeProductCollection $order, Module $module)
    {
        ...
        $data['transaction']['test_mode'] = !empty($this->novalnetccTestMode) ? $this->novalnetccTestMode : '0';
        ...
        if ($this->novalnetccOneClickShopping == 1) {
        ...
        if ($this->novalnetccPaymentAction == 'Authorize' && ($this->novalnetccOnHoldLimit <= $data['transaction']['amount'])) {
