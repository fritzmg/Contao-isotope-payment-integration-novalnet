...
$GLOBALS['TL_LANG']['tl_iso_payment'] = array_merge($GLOBALS['TL_LANG']['tl_iso_payment'], [
    ...
    'novalnetglobalconfigTariffId' => ['Tariff ID', ''],
...
Additional e-mails to which Webhook execution messages will be sent'],
    'novalnetglobalconfigWebHookSendMail' => ['Send e-mail to', ''],
    ...
    'novalnetinvoiceCallbackOrderStatus' => ['Payment callback status', 'Status to be used when callback script is executed for payment received by Novalnet'],
    ...
    'novalnetccOneClickShopping' => ['One-click shopping', ''],
    ...
    'novalnetsepaOneClickShopping' => ['One-click shopping', ''],
    ...
    'novalnetprepaymentCallbackOrderStatus' => ['Payment callback status', 'Status to be used when callback script is executed for payment received by Novalnet'],
    ...
    'novalnetguaranteedinvoiceForceNonGuarantee' => ['Force non-guarantee payment', ''],
    ...
    'novalnetguaranteedsepaOneClickShopping' => ['One-click shopping', ''],
    ...
    'novalnetguaranteedsepaForceNonGuarantee' => ['Force non-guarantee payment', ''],
    ...
    'novalnetbarzahlenCallbackOrderStatus' => ['Payment callback status', 'Status to be used when callback script is executed for payment received by Novalnet'],
    ...
    'novalnetinstalmentsepaOneClickShopping' => ['One-click shopping', ''],
    ...
    'novalnetpaypalOneClickShopping' => ['One-click shopping', ''],
    ...
    'novalnetmultibancoCallbackOrderStatus' => ['Payment callback status', 'Status to be used when callback script is executed for payment received by Novalnet'],
]);
