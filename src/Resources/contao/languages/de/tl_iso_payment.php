...
$GLOBALS['TL_LANG']['tl_iso_payment'] = array_merge($GLOBALS['TL_LANG']['tl_iso_payment'], [
    ...
    'novalnetglobalconfigTariffId' => ['Tarif-ID', 'Geben Sie die Tarif-ID, die dem bevorzugten Tarifplan entspricht, den Sie im Novalnet Admin-Portal für dieses Projekt erstellt haben'],
    ...
    'novalnetglobalconfigWebHookSendMail' => ['E-Mails senden an', 'E-Mail-Benachrichtigungen werden an diese E-Mail-Adresse gesendet'],
    ...
    'novalnetinvoiceCallbackOrderStatus' => ['Callback / Webhook Bestellstatus', 'Status, der zu verwendet wird, wenn das Callback-Skript für eine bei Novalnet eingegangene Zahlung ausgeführt wird'],

    'novalnetccTestMode' => ['Testmodus aktivieren', 'Aktivieren Sie diese Option, um das Bezahlen auf Ihrer Checkout-Seite zu testen. Im Testmodus werden Zahlungen nicht von Novalnet ausgeführt. Vergessen Sie nicht, den Testmodus nach dem Testen wieder zu deaktivieren, um sicherzustellen, dass die echten Bestellungen ordnungsgemäß abgerechnet werden'],
    'novalnetccOneClickShopping' => ['Kauf mit einem Klick', 'Zahlungsdaten, die während des Bestellvorgangs gespeichert werden, können für zukünftige Zahlungen verwendet werden'],
    ...
    'novalnetsepaOneClickShopping' => ['Kauf mit einem Klick', 'Zahlungsdaten, die während des Bestellvorgangs gespeichert werden, können für zukünftige Zahlungen verwendet werden'],
    ...
    'novalnetprepaymentCallbackOrderStatus' => ['Callback / Webhook Bestellstatus', 'Status, der zu verwendet wird, wenn das Callback-Skript für eine bei Novalnet eingegangene Zahlung ausgeführt wird'],
    ...
    'novalnetguaranteedsepaOneClickShopping' => ['Kauf mit einem Klick', 'Zahlungsdaten, die während des Bestellvorgangs gespeichert werden, können für zukünftige Zahlungen verwendet werden'],
    ...
    'novalnetguaranteedsepaForceNonGuarantee' => ['Zahlung ohne Zahlungsgarantie erzwingen', 'Falls die Zahlungsgarantie zwar aktiviert ist, jedoch die Voraussetzungen für Zahlungsgarantie nicht erfüllt sind, wird die Zahlung ohne Zahlungsgarantie verarbeitet. Die Voraussetzungen finden Sie in der Installationsanleitung unter "Zahlungsgarantie aktivieren"'],
    ...
    'novalnetbarzahlenCallbackOrderStatus' => ['Callback / Webhook Bestellstatus', 'Status, der zu verwendet wird, wenn das Callback-Skript für eine bei Novalnet eingegangene Zahlung ausgeführt wird'],
    ...
    'novalnetinstalmentsepaOneClickShopping' => ['Kauf mit einem Klick', 'Zahlungsdaten, die während des Bestellvorgangs gespeichert werden, können für zukünftige Zahlungen verwendet werden'],
    ...
    'novalnetpaypalOneClickShopping' => ['Kauf mit einem Klick', 'Zahlungsdaten, die während des Bestellvorgangs gespeichert werden, können für zukünftige Zahlungen verwendet werden'],
    ...
    'novalnetmultibancoCallbackOrderStatus' => ['Callback / Webhook Bestellstatus', 'Status, der zu verwendet wird, wenn das Callback-Skript für eine bei Novalnet eingegangene Zahlung ausgeführt wird'],
]);
